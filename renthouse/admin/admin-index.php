...
<body>
 ...
 <div class="container-fluid">
  <ul class="nav nav-pills nav-justified"   style=" font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;font-size:15px;font-weight:bold;">
    <li class="active" style="background-color: #9dc99d;"><a data-toggle="pill" href="#home" style=color:white; >Property Lists</a></li>
    <li style="background-color: #9dc99d;color:white ;";><a data-toggle="pill" href="#menu1" style=color:white;>Owners Details</a></li>
    <li style="background-color: #9dc99d;"><a data-toggle="pill" href="#menu2" style=color:white;>Customer Details</a></li>
  </ul>
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <center><h3 style="color: #426942;font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;font-size:30px;">Property Lists</h3></center>
      <div class="container-fluid">
...
<?php $sql2="SELECT * from property_photo where property_id='$property_id'";
    ...
    <div id="menu1" class="tab-pane fade">
      <center><h3 style="color: #426942;font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;font-size:30px;">Owner Details</h3></center>
      <div class="container-fluid">
    ...
    <div id="menu2" class="tab-pane fade">
      <center><h3  style="color: #426942;font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;font-size:30px;">Tenant Details</h3></center>
      <div class="container">
    ...
    <div id="menu3" class="tab-pane fade">
      <center><h3 style="color: #426942;font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;font-size:30px;">Booked Property</h3></center>
      <div class="container">
