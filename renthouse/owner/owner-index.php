 ...
 <div class="container-fluid">
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <center><h3 style="color: #426942; font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif; font-weight:bold;">Owner Profile</h3></center>
      <div class="container">
      <?php 
//        include("../config/config.php");
  ...
  <p class="title" style=" font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;"><?php echo $rows['email']; ?></p>
  <p><b style=" font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;color: #426942;">Phone No.: </b><?php echo $rows['phone_no']; ?></p>
  <p><b style=" font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;color: #426942;">Address: </b><?php echo $rows['address']; ?></p>
  <p><b style=" font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;color: #426942;">Id Type: </b><?php echo $rows['id_type']; ?></p>
  <p><img src="../<?php echo $rows['id_photo']; ?>" height="100px"></p>

  <!-- Trigger the modal with a button -->
  <p><button type="button" class="btn btn-lg" data-toggle="modal" data-target="#myModal" style="background-color: #426942;">Update Profile</button></p>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div class="form-group">
      ...
      <img src="../<?php echo $rows['id_photo']; ?>" id="output_image"/ height="100px" readonly>
                ...
                <hr>
                <center><button id="submit" name="owner_update" class="btn btn-primary btn-block" style="background-color: #426942;font-weight:bold;">Update</button></center><br>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal" style="background-color: #426942;font-weight:bold;">Close</button>
        </div>
      </div>
