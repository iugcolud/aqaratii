...
<div class="container" style="color: #426942; width: 40%;height: 50px;background: transparent;border: none;outline: none; font-size: 17px; padding:0 35px 0 5px; text-align: left;">
  <h3 style="font-weight: bold; text-align: center; color: #426942; font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;">Owner Register</h3><hr><br>
  <form method="POST" action="owner-engine.php" enctype="multipart/form-data">
    ...
    <hr>
    <center><button id="submit" name="owner_register" class="btn btn-primary btn-block" onclick="return Validate()" style="font-size:20px;background-color:#426942;font-family:Century Gothic, CenturyGothic, AppleGothic, sans-serif;font-weight:bold;">Register</button></center><br>
    <div class="form-group text-right" >
      <label class="">Register as a <a href="tenant-register.php" style="color:red;">Customer</a>?</label><br>
    </div><br><br>
  </form>
</div>
